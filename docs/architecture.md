...
`make-symlink` act purity is paid: observation carries candidate paths and existence, while act consumes that state and tracks successful do mutations through cleanup and promotion.
