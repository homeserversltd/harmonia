...
pub const NAME: &str = "hotfix";
pub const DESCRIPTION: &str =
    "Emergency one-shot hotfix primitive with explicit receipt and retirement path.";
...
pub fn hotfix_request(action: impl Into<String>) -> Request {
    Request::new(action)
}
