...
This is Harmonia's single shared Chromium configuration module. Profiles consume it by listing the module id `chromium`; the resolver selects this canonical `shared/modules/chromium` seat when no profile-local module exists.
