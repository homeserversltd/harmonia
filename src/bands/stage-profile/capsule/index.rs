...
pub(crate) fn demo(
    ...
    let result = (|| {
        ...
        .all(|v| *v == Some(true))
            ...
            && root_owned_full_fidelity_differs
            && stale_module_pruned
            && unowned_preserved;
        Ok(
            serde_json::json!({"payload_bytes_exact":payload_bytes_exact,"packed_module_directory_real":packed_module_directory_real,"source_hash_equals_dereferenced_copy":source_hash_equals_dereferenced_copy,"content_hashes_equal":content_hashes_equal,"root_owned_full_fidelity_differs":root_owned_full_fidelity_differs,"full_fidelity_hashes_differ":root_owned_full_fidelity_differs,"source_content_sha256":source_content_hash,"packed_content_sha256":packed_content_hash,"source_full_sha256":source_module_hash,"packed_full_sha256":packed_module_hash,"root_owned_full_sha256":root_owned_full_sha256,"pack_ok":pack["ok"],"verify_ok":verify["ok"],"plan_ok":plan["ok"],"install_ok":install["ok"],"stale_module_pruned":stale_module_pruned,"subscription_unowned_fields_preserved":unowned_preserved,"pack_receipt":pack,"verify_receipt":verify,"install_receipt":install,"ok":ok}),
        )
    })();
