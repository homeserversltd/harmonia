...
pub const PERMUTATIONS: &[ToolPermutation] = &[
    ...
    ToolPermutation::new(
        ...
        &[
            ...
            ToolArg::optional("launcher_source_root", ToolArgKind::String),
            ToolArg::optional("launcher_target_root", ToolArgKind::String),
            ToolArg::optional("launcher_pattern", ToolArgKind::String),
            ...
            ToolArg::optional("launcher_mode", ToolArgKind::Integer),
