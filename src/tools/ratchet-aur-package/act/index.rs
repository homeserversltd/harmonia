...
use super::observe::load_pinned_lock;
use crate::{hyalos, value_arg, value_arg_string, write_json, PinnedArtifact, PinnedArtifactsLock, Profile};
use serde_json::json;
use crate::atoms;
...
pub(super) fn pinned_artifacts_nudge(
    ...
    let actual_sha = super::observe::sha256_file(&candidate)?;
