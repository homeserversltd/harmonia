...
pub const DESCRIPTION: &str = "Python virtualenv preservation/update primitive for compatibility surfaces; not a Harmonia authority lane.";
...
pub fn venv_request(action: impl Into<String>) -> Request {
    Request::new(action)
}
