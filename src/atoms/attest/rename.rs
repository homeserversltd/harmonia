//! Typed receipt writer for the rename filesystem ask.
use crate::atoms::ask::rename as ask;
...
pub(crate) fn attest(
    ...
    let value = serde_json::json!({"schema":"harmonia.fs.rename.v1","ok":outcome.ok,"observation":observation.projection,"outcome":outcome.projection});
