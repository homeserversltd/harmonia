//! Typed receipt writer for the change-owner filesystem ask.
use crate::atoms::ask::change_owner as ask;
...
pub(crate) fn attest(
    ...
    let value = serde_json::json!({"schema":"harmonia.fs.change_owner.v1","ok":outcome.ok,"observation":observation.projection,"outcome":outcome.projection});
