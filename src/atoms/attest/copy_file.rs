//! Typed receipt writer for the copy-file filesystem ask.
use crate::atoms::ask::copy_file as ask;
...
pub(crate) fn attest(
    ...
    let value = serde_json::json!({"schema":"harmonia.fs.copy_file.v1","ok":outcome.ok,"observation":observation.projection,"outcome":outcome.projection});
