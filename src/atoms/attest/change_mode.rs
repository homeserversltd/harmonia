//! Typed receipt writer for the change-mode filesystem ask.
use crate::atoms::ask::change_mode as ask;
...
pub(crate) fn attest(
    ...
    let value = serde_json::json!({"schema":"harmonia.fs.change_mode.v1","ok":outcome.ok,"observation":observation.projection,"outcome":outcome.projection});
