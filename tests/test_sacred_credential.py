...
class SacredCredentialShelfTests(unittest.TestCase):
    ...
    def test_shelf_and_manifest_install_the_admitted_surface_without_legacy_lineage(self) -> None:
        ...
        self.assertNotIn("household_capability", rendered)
        self.assertNotIn("caduceus-keyman-sign-capability", rendered)
        self.assertNotIn("caduceus-keyman-rotate-capability", rendered)
        self.assertNotIn("caduceus-skeleton-sha", rendered)
