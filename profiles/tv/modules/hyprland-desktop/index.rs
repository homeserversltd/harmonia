...
pub(crate) const ID: &str = "hyprland-desktop";
...
pub(crate) fn execute(
    ...
    tv_runtime_support::execute(
        ...
        TvModuleSpec {
            phase: 3,
            schema: "harmonia.tv.hyprland_desktop.v1",
            meaning: "Hyprland, portals, desktop shell, browser, audio, and KDE integration packages are maintained",
        },
    )
}
