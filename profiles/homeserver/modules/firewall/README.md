...
The firewall concern defines which services a HOMESERVER appliance exposes and which traffic remains internal. It is part of the product safety boundary, not a miscellaneous host tweak.

## Harmonia maintenance contract

This module represents package state, policy shape, allowed service surfaces, and receipt-backed validation. Harmonia will use this concern to make network exposure explicit and repeatable.
